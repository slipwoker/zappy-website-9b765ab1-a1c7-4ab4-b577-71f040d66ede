    ...
    if (contactForm) {
        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('required') && value === '') {
                const label = field.getAttribute('data-label') || name || 'This field';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9b765ab1-a1c7-4ab4-b577-71f040d66ede',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9b765ab1-a1c7-4ab4-b577-71f040d66ede';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9b765ab1-a1c7-4ab4-b577-71f040d66ede';
